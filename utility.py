...
OBJECTIVES_STR_IDX = 0
OBJECTIVES_COUNT_IDX = 1
...
RED = ('R', '\033[41m')         # Red
BLUE = ('B', '\033[44m')        # Blue
GREEN = ('G', '\033[42m')       # Green
YELLOW = ('Y', '\033[103m')     # Yellow
PURPLE = ('P', '\033[105m')     # Purple
COLOR_BOMB = ('C', '\033[107m') # White
LINE_BOMB = ('L', '\033[100m')  # Grey
AREA_BOMB = ('A', '\033[106m')  # Cyan
BLOCKER = ('X', '\033[40m')     # Black
